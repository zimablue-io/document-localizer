...
## [0.2.0](https://github.com/zimablue-io/document-localizer/compare/v0.1.9...v0.2.0) (2026-04-27)


### Features

* add platform related copy/instructions for landing page ([69315b9](https://github.com/zimablue-io/document-localizer/commit/69315b9d25e8548e3a501ce46f0261e1f4d8d358))


### Bug Fixes

* add workflow_dispatch trigger and concurrency settings to build and release workflows ([8dbc9e0](https://github.com/zimablue-io/document-localizer/commit/8dbc9e09479090a5493f8b68a4bada2820dc682b))

## [0.1.9](https://github.com/zimablue-io/document-localizer/compare/v0.1.8...v0.1.9) (2026-04-26)


### Bug Fixes

* remove skip-github-pull-request option from release-please action ([13174be](https://github.com/zimablue-io/document-localizer/commit/13174be283653ec3d97261dd8275c58f375baebb))
